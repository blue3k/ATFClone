...
namespace Sce.Atf.Controls
{
    ...
    public class Int64DataEditor : DataEditor
    {
        ...
        public override void OnContextChanged()
        {
            ...
            Value = (Int64)Convert.ChangeType(EditingContext.GetValue(), typeof(Int64));
        }
        ...
        public override void OnMouseMove(MouseEventArgs e)
        {
            if (ShowSlider && EditingMode == EditMode.BySlider)
                Value = (Int64)GetSliderFloatValue(e.X);
        }
        ...
        {
            Int64 singleResult;
            if (Int64.TryParse(s, out singleResult))
            {
