...
namespace Sce.Atf.Gui.TitleBarTab
{
	...
	public class TitleBarTabItem
	{
		...
		protected TitleBarTabMainForm _parent;
		...
		/// <summary>Parent window that contains this tab.</summary>
		public TitleBarTabMainForm Parent
		{
			get
			{
				return _parent;
		...
		public Form Content
		{
			...
			set
			{
                ...
                // TODO: This is bad. I need to use MID container
                System.Diagnostics.Debug.Assert(Content.IsMdiContainer == false);
		...
		/// <summary>
		/// Called from <see cref="TitleBarTornTabForm" /> when we need to generate a thumbnail for a tab when it is torn out of its parent window.  We simply call
