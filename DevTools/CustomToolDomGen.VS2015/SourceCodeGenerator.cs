...
namespace DomGen
{
    ...
    public static class SourceCodeGenerator
    {
        ...
        public static CodeCompileUnit CreateCodeCompileUnit(XmlDocument doc, string namespaceName)
        {
            ...
            if (root.Name != "Types")
            {
                throw new ArgumentException(string.Format("Invalid Root".Localize(), root.Name));
            }

            if (root.ChildNodes.Count == 0)
            {
                throw new ArgumentException("No Types".Localize());
            }
            ...
            foreach (XmlNode node in root.ChildNodes)
            {
                switch (node.Name)
                {
                    ...
                    case "Enum":
                        ...
                        break;
                    default:
                        throw new ArgumentException(string.Format("Invalid Type".Localize(), node.Name));
                }
            }
        ...
        private static CodeTypeDeclaration CreateClass(XmlNode node)
        {
            ...
            switch (classAccess)
            {
                ...
                case "internal":
                    ...
                    break;
                default:
                    throw new ArgumentException(string.Format("Bad Type Access".Localize(), classAccess));
            }
        ...
        private static void GetClassInfo(XmlNode node, out string className, out string classAccess, out bool isPartial)
        {
            ...
            {
                throw new ArgumentException("Class Node No Name".Localize());
            }
            ...
            else
            {
                switch (fieldAccess)
                {
                    ...
                    case "private":
                        ...
                        break;
                    default:
                        throw new ArgumentException(string.Format("Bad Variable Access".Localize(), fieldAccess));
                }
        ...
        private static void GetFieldInfo(XmlNode n, out string memberName, out string memberAccess, out string memberValue, out string memberType, out bool memberIsStatic)
        {
            ...
            {
                throw new ArgumentException(string.Format("Bad Class Member Name".Localize(), n.Name));
            }
            ...
            {
                throw new ArgumentException("Class Member No Name".Localize());
            }
            ...
            {
                throw new ArgumentException("Class Member No Type".Localize());
            }
            ...
            else
            {
                if (n.Name == "Constant")
                {
                    throw new ArgumentException("Constant No Value".Localize());
                }
                else
                {
                    memberValue = null;
        ...
        private static CodeTypeDeclaration CreateEnum(XmlNode node)
        {
            ...
            switch (enumAccess)
            {
                ...
                case "internal":
                    ...
                    break;
                default:
                    throw new ArgumentException(string.Format("Bad Type Access".Localize(), enumAccess));
            }
        ...
        private static void GetEnumMemberInfo(bool enumFlagsAttribute, XmlNode n, out string memberName, out int memberValue, out bool hasValue)
        {
            ...
            {
                throw new ArgumentException(string.Format("EnumNodeNoName".Localize(), n.Name));
            }
            ...
            {
                throw new ArgumentException("Enum Member Node No Name".Localize());
            }
            ...
            else
            {
                if (enumFlagsAttribute)
                {
                    throw new ArgumentException("Enum Member Value Missing".Localize());
                }
                else
                {
                    memberValue = 0;
        ...
        private static void GetEnumInfo(XmlNode node, out string enumName, out string enumAccess, out bool enumFlagsAttribute)
        {
            ...
            {
                throw new ArgumentException("Enum Node No Name".Localize());
            }
            
            if (node.ChildNodes.Count == 0)
            {
                throw new ArgumentException("Enum No Members".Localize());
            }
