...
namespace VisualScript
{
    ...
    public class PrintableDocument : DomNodeAdapter, IPrintableDocument
    {
        ...
        {
            public void SetDocument(VisualScriptEditor.VisualScriptEditingContext editingContext, ViewingContext viewingContext)
            {
            ...
            private VisualScriptEditor.VisualScriptEditingContext m_editingContext;
