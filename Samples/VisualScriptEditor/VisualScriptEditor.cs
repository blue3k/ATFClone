...
namespace VisualScriptEditor
{
    ...
    [Export(typeof(VisualScriptEditor))]
    [Export(typeof(IInitializable))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class VisualScriptEditor : DynamicObject, IDocumentClient, IControlHostClient, IInitializable
    {
        /// <summary>
        ...
        void IInitializable.Initialize()
        {
            if (m_scriptingService != null)
            {
                ...
                m_scriptingService.ImportAllTypes("VisualScriptEditor");
                ...
                {
                    var editingContext = m_contextRegistry.GetActiveContext<VisualScriptEditingContext>();
        ...
        private void control_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (subGraph != null)
            {
                ...
                else
                {
                    ...
                    var editingContext = subGraph.DomNode.Cast<VisualScriptEditingContext>();
                    editingContext.GetLocalBound = GetLocalBound;
                    editingContext.GetWorldOffset = GetWorldOffset;
                    editingContext.GetTitleHeight = GetTitleHeight;
                    editingContext.GetLabelHeight = GetLabelHeight;
                    ...
                    var enumerableContext = subGraph.DomNode.Cast<VisualScriptEditingContext>().Cast<IEnumerableContext>();
